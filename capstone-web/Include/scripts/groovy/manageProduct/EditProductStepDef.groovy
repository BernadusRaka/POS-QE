...
class EditProductStepDef {
	...
	def clickPenIcon() {
		WebUI.click(findTestObject('Object Repository/Page_Qbills  Manage Product/button_LARGE_flex items-center justify-cent_bdf184'))
	}

	@And("Ubah bagian yang ingin diedit")
	def editProduct() {
		WebUI.setText(findTestObject('Object Repository/Page_Qbills  Manage Product/input_Price_price-0'), '22000')
	}
