...
WebUI.click(findTestObject('Object Repository/Page_Qbills  Manage Product/a_Membership'))

WebUI.click(findTestObject('Object Repository/Page_Qbills  Membership/button_Alvi_flex items-center justify-cente_d488e3'))

WebUI.click(findTestObject('Object Repository/Page_Qbills  Membership/div_Edit MembershipView CardName Number Pho_3c2f30'))
