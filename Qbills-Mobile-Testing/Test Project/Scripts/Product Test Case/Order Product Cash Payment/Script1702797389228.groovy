...
Mobile.tap(findTestObject('Object Repository/Order Test/AddCartButton'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/Order Test/CashPayment'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/Order Test/QRISPayment'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/Order Test/BankPayment'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/Order Test/PaymentConfirmationButton'), 0)

Mobile.tap(findTestObject('Object Repository/Order Test/CashPayment'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/Order Test/AlreadyPaidButton'), 0)

Mobile.tap(findTestObject('Object Repository/Order Test/AlreadyPaidButton'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/Order Test/PaymentSuccess'), 0)
