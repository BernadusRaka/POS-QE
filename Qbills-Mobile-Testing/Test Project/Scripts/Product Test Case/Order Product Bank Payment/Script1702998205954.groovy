...
Mobile.verifyElementExist(findTestObject('Order Test/AddCartButton'), 0)
...
Mobile.tapAtPosition(927, 1964)

Mobile.verifyElementExist(findTestObject('Order Test/BRIPaymentButton'), 0)

Mobile.tap(findTestObject('Order Test/BRIPaymentButton'), 0)

Mobile.verifyElementExist(findTestObject('Order Test/PaymentConfirmationButton'), 0)

Mobile.tap(findTestObject('Order Test/PaymentConfirmationButton'), 0)

Mobile.verifyElementExist(findTestObject('Order Test/PaymentSuccess'), 0)
