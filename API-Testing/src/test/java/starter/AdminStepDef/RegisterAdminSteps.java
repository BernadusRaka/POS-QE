...
/*
Register Admin tanpa token
 */
    @When("Admin mencoba mengakses endpoint untuk mendaftarkan Admin tanpa token")
    public void noTokenRegister(){
        registerAdmin.adminRegisterNoToken();
    }

    @Then("Admin menerima pesan kesalahan untuk token")
    public void errorToken(){
        registerAdmin.noTokenError();
    }
