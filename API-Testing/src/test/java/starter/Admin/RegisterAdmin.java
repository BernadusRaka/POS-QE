...
public class RegisterAdmin {
    ...
    /*
    Admin Register tanpa token
     */
    @Step("Admin mencoba mengakses endpoint untuk mendaftarkan Admin tanpa token")
    public void adminRegisterNoToken() {
        JSONObject requestBody = new JSONObject();
        Faker faker = new Faker();
        String fullname = faker.name().lastName();
        String username = faker.name().username();
    ...
    @Step("Admin menerima pesan kesalahan untuk token")
