...
#Scenario: Admin Unauthorized access tanpa token menambahkan tipe produk baru
#When pengguna mencoba mengakses endpoint untuk menambahkan tipe produk tanpa token
