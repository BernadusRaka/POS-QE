...
#Scenario: Admin Unauthorized access tanpa token ingin mengubah data tipe produk
#When pengguna mencoba mengakses endpoint untuk mengubah data tipe produk tanpa token
