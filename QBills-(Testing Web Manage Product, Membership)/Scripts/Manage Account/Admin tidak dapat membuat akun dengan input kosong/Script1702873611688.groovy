...
WebUI.click(findTestObject('Object Repository/Page_Qbills  Manage Account/span_Add Account'))

WebUI.click(findTestObject('Object Repository/Page_Qbills  Manage Account/button_Add'))

WebUI.click(findTestObject('Object Repository/Page_Qbills  Manage Account/p_Add data failed'))

WebUI.click(findTestObject('Object Repository/Page_Qbills  Manage Account/div_Add Account CashierFullname Username Pa_68f6e7'))
