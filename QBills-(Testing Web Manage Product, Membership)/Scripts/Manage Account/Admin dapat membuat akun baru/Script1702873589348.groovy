...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_QBills  Login/input_password'), '9NLz+4tGZcQ=')
...
WebUI.click(findTestObject('Object Repository/Page_Qbills  Manage Account/div_flex h-full w-full items-center justify_a20dc2'))
