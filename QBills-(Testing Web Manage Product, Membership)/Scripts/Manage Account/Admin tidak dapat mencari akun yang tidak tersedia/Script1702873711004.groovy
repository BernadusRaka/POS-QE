...
WebUI.click(findTestObject('Object Repository/Page_Qbills  Dashboard/li_Manage Account'))
...
WebUI.click(findTestObject('Object Repository/Page_Qbills  Manage Account/div_FullnameUsernamePassword'))
